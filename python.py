...
print(f"JSON file read completed in {json_elapsed_time} seconds")
...
print(f"Find items startswith 'D' completed in {for_loop_elapsed_time} seconds")
...
print(f"Find and sum the length of each item completed in {total_length_elapsed_time} seconds")
...
print(f"Create long string completed in {long_string_elapsed_time} seconds")
...
print(f"Convert to binary completed in {to_binary_elapsed_time} seconds")
print("-------------")
